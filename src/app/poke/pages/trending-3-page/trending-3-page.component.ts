...
@Component({
  selector: 'trending-3-page',
  templateUrl: './trending-3-page.component.html',
  imports: [PokeMasonry],
})
export default class Trending3PageComponent implements AfterViewInit {
  ...
  onScroll(event: Event) {
    ...
    if (isNearBottom) {
      this.pokeService.loadMoreGeneration3Pokemon();
    }
  }
}
